...
import {  newVacationValidatorAdmin, updateVacationValidatorAdmin, validationVacationParamsAdmin } from "../controllers/admin/validator";
...
adminRouter.patch('/edit/:id', paramsValidation(validationVacationParamsAdmin), validation(updateVacationValidatorAdmin), editVacation)
